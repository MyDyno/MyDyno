        ...
        if(client.config.botDeveloperId.includes(message.author.id)){
            ...
            let advertisement1 = new Discord.MessageEmbed()
                ...
                .setDescription(
                    ...
                    '\n\n' +
                    'This message was sent to you by me `' + client.config.botDeveloperTag + '` **VERY SORRY IF IT LOOKS LIKE SPAM** and also to everyone from the mutual servers because we need your support to grow across servers!' + 
                    '\n\n' +
